...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "com.cenpro.cbppag.controller",
        "com.cenpro.cbppag.configuracion.security", "com.cenpro.cbppag.aspecto" })
...
public class MvcConfiguration extends WebMvcConfigurerAdapter implements ApplicationContextAware
{
    ...
    public MessageSource messageSource()
    {
        ...
        bean.setBasenames("classpath:/message/validacion", "classpath:/message/mantenimiento",
                ...
                "classpath:/message/ingresos","classpath:/message/egresos",
